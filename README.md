...
- [Pub/Sub](https://godoc.org/github.com/liues1992/redis-proxy#PubSub).
- [Transactions](https://godoc.org/github.com/liues1992/redis-proxy#Multi).
- [Pipeline](https://godoc.org/github.com/liues1992/redis-proxy#example-Client-Pipeline) and [TxPipeline](https://godoc.org/github.com/liues1992/redis-proxy#example-Client-TxPipeline).
- [Scripting](https://godoc.org/github.com/liues1992/redis-proxy#Script).
- [Timeouts](https://godoc.org/github.com/liues1992/redis-proxy#Options).
- [Redis Sentinel](https://godoc.org/github.com/liues1992/redis-proxy#NewFailoverClient).
- [Redis Cluster](https://godoc.org/github.com/liues1992/redis-proxy#NewClusterClient).
- [Ring](https://godoc.org/github.com/liues1992/redis-proxy#NewRing).
- [Instrumentation](https://godoc.org/github.com/liues1992/redis-proxy#ex-package--Instrumentation).
- [Cache friendly](https://github.com/go-redis/cache).
- [Rate limiting](https://github.com/liues1992/redis-proxy_rate).
- [Distributed Locks](https://github.com/bsm/redis-lock).

API docs: https://godoc.org/github.com/liues1992/redis-proxy.
Examples: https://godoc.org/github.com/liues1992/redis-proxy#pkg-examples.
...
```shell
go get -u github.com/liues1992/redis-proxy
```
...
Please go through [examples](https://godoc.org/github.com/liues1992/redis-proxy#pkg-examples) to get an idea how to use this package.
